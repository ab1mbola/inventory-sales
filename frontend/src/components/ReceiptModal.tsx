      ...
      >
        ...
        <div className="p-10 flex-1 overflow-y-auto print:p-0 print:overflow-visible no-scrollbar bg-white" id="receipt-content">
          <div className="text-center mb-12">
            <h1 className="text-4xl font-serif font-bold tracking-tighter uppercase italic leading-none">Inventory</h1>
          ...
          <div className="text-center space-y-6">
            ...
            <p className="text-[8px] font-bold text-muted/30 uppercase tracking-[0.5em]">Generated by Inventory System</p>
          </div>
        </div>
