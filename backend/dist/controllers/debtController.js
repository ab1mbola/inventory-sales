...
exports.recordPayment = exports.getCustomerDebtDetails = exports.getDebtors = void 0;
...
const getCustomerDebtDetails = async (req, res) => {
    try {
        const { id } = req.params;
...
exports.getCustomerDebtDetails = getCustomerDebtDetails;
const recordPayment = async (req, res) => {
    try {
        ...
        const payment = await prisma_1.prisma.customerPayment.create({
            data: {
                customerId,
